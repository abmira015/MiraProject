...
function Dashboard() {
  ...
  const handleCreateUser = async (e) => {
    ...
    try {
      ...
      await axios.post(`${API_ENDPOINT}/user`, {fullname, age, username, passwordx}, { headers:headers }).then(({data})=>{
  ...
  //     console.log('Updating user:', selectedUser.user_id, editUser);

  //     await axios.put(`${API_ENDPOINT}/user/${selectedUser.user_id}`, editUser, { headers });
